...
const LEGITIMAS = [
  ...
  'O Pró custa R$ 39,90 por mês, ou R$ 399 no ano, e libera cardápio, promoções, eventos e fotos.',
  'O Premium é R$ 69,90 por mês e soma logo no pino, avaliações e cor personalizada.',
  'O Enterprise é R$ 129,90 por mês, com 3 pontos inclusos e R$ 19,90 por ponto a mais.',
  'A indicação direta paga 15% de cada mensalidade paga pelo indicado, enquanto ele continuar pagando.',
  ...
  'O teste grátis é de 30 dias de Pró e ao vencer cai sozinho para o Básico, sem cobrança surpresa.',
