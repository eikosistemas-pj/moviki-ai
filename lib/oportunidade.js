...
function escolher(c) {
  ...
  if (plano === 'pro' && c.planoAtivo && Number(c.views14) >= VISITAS_PARA_PREMIUM) {
    cand.push({
      ...
      proposta: 'Com esse movimento, o proximo passo e transformar visita em venda: o Premium libera o Modo Live (transmitir e vender pela camera do celular) e a VENDA PELO CARDAPIO, com o Pix caindo direto na conta dela, sem comissao por venda. Soma tambem fotos e videos, logo propria no pino e cor da marca. Cite o numero real de visitas dela. NAO cite avaliacoes como vantagem do Premium: avaliacoes sao de todos os planos, ela ja tem. Nao prometa aumento de venda nem publico na live.',
    });
  }
  ...
  if (plano === 'premium' && c.planoAtivo && Number(c.views14) >= VISITAS_PARA_ENTERPRISE) {
    cand.push({
      ...
      proposta: 'Dois caminhos, nesta ordem: (1) se ela ja faz live, o Enterprise poe o PIX DENTRO da transmissao — o cliente paga sem sair da live —, alem de 3 horas por live, sacolinha de 20, oferta relampago, estoque ao vivo, cupom e fila de pedidos; (2) se ela atende em mais de um lugar, da ponto proprio com link, localizacao e WhatsApp separados (3 inclusos). PERGUNTE antes de propor o multi-ponto — nao afirme que ela atende em mais de um ponto.',
    });
  }
