...
const CATALOGO_VERSAO = '2026-09-23-5';
const CATALOGO_EM = '23/09/2026';
...
- Material de apoio: artes prontas de feed e stories, videos, textos prontos
  ...
  Navegacao (desde 19/09): no topo, dois cartoes grandes, "Para qualquer
  negocio" e "Chamar parceiro". Embaixo, o botao "Material por ramo do
  comerciante", que abre uma grade de ramos com icone (Alimentacao,
  Artesanato, Beleza, Carro e moto, Eletronicos, Fotografia e eventos, Moda,
  Naturais, Papelaria, Pet, Servicos) e fecha ao escolher. Depois vem o tipo
