...
- Fotos e videos: e UMA tela so. Em cima "Videos do negocio", ate 6, colando
  ...
  "Trocar capa". As formas, na ordem em que valem a pena:
   1. TIKTOK, SOZINHO: video do TikTok ja TENTA pegar a capa na hora em que o
      link e colado, sem o lojista pedir nada. Dentro da folha de capa ainda
      existe o botao "Buscar a capa no TikTok" para tentar de novo. Se o
      TikTok nao devolver, nao e erro: ele escolhe a capa na mao. O Instagram
      NAO tem esse caminho — eles fecharam a saida publica, e prometer que
      existe so geraria tentativa que sempre falha.
   2. Usar uma foto que ele JA tem na galeria (instantaneo, sem envio).
   3. "ESCOLHER A CENA DO VIDEO DO MEU CELULAR" — abre o arquivo do video que
      esta no aparelho dele, ele arrasta a linha do tempo e escolhe a cena,
      igual ao Instagram. O video NAO e enviado para lugar nenhum: tudo
      acontece no aparelho e sai so a imagem da cena.
   4. Enviar uma imagem nova.
  NAVEGADOR DE DENTRO DO APLICATIVO (16/09/2026): se o lojista abriu o painel
  clicando num link dentro do Instagram, do Facebook ou do TikTok, ele esta no
  navegador EMBUTIDO desses aplicativos, e esse navegador NAO abre video do
  celular — a tela fica preta e a cena nunca aparece. Nao e defeito do painel
  nem do video dele. A tela avisa antes e avisa de novo se a cena nao vier: a
  saida e abrir app.moviki.com.br no Chrome (ou Safari). Se alguem disser que
  "a tela fica escura quando arrasto", PERGUNTE POR ONDE ELE ABRIU O PAINEL
  antes de qualquer outra coisa — e de longe a causa mais comum. A segunda
  causa e o formato do arquivo (.mov de iPhone em alta eficiencia em alguns
  Android); nesse caso o caminho e foto da galeria ou enviar imagem.
