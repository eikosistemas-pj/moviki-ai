...
const CATALOGO_VERSAO = '2026-09-13-1';
const CATALOGO_EM = '13/09/2026';
...
const MARCAS_CONFERIDAS = {
  lojista: '2026-09-13-vikpainel',
  parceiro: '2026-09-13-vikpainel',
};
/* Marcas anteriores, para o historico: o catalogo foi escrito lendo o
   index.html em '2026-09-12-beta1' e o parceiro.html em
   '2026-09-11-material-aulaniveis'. Os dois sobem nesta mesma rodada com a
   marca '2026-09-13-vikpainel', que e a registrada acima — se ficasse a
   antiga, o modo cauteloso nasceria ligado para todo mundo e o aviso
   perderia o sentido de aviso. */
...
A folha "Acao rapida" tem: Fazer live (quando liberada), Adicionar fotos,
...
=== MODO LIVE (transmissao ao vivo) ===
Recurso do Premium; as ferramentas de venda sao do Enterprise. Alem do
plano, esta em BETA FECHADO: o botao "Fazer live" so aparece para quem foi
liberado. Quem nao foi liberado nao ve o botao — se perguntarem, diga que a
live esta sendo aberta aos poucos e que da para avisar o time por aqui.
...
- Material de apoio: artes prontas de feed e stories, videos, textos prontos
  ...
  Todo mundo VE; para baixar e postar precisa estar aprovado, ter terminado
  as aulas e ter aceitado o compromisso de conduta.
